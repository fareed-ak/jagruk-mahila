...
import { SEXUAL_CRIMES_DATA } from '../constants/sexualCrimesData';
...
export default function Sexual() {
    ...
    const headerTitle = () =>
        ({ hi: 'यौन अपराध', ur: 'جنسی جرائم' }[lang] || 'Sexual Crimes');
    ...
    const renderSubcategoryList = () => (
        ...
        >
            {SEXUAL_CRIMES_DATA.subcategories.map((sub) => (
                <TouchableOpacity
                    key={sub.id}
