...
import { BNSS_DATA } from '../constants/bnssData';
...
export default function Bnss() {
    ...
    const headerTitle = () =>
        ({ hi: 'भारतीय न्याय संहिता', ur: 'بھارتیہ نیائے سنہتا' }[lang] || 'Bharatiya Nyaya Sanhita');
    ...
    const renderSubcategoryList = () => (
        ...
        >
            {BNSS_DATA.subcategories.map((sub) => (
                <TouchableOpacity
                    key={sub.id}
