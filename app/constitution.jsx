...
import { CONSTITUTION_DATA } from '../constants/constitutionData';


// ─────────────────────────────────────────────
// Navigation levels
// 0 → subcategory list
// 1 → items list within a subcategory
// 2 → full detail of a single item
// ─────────────────────────────────────────────
...
export default function Constitution() {
    ...
    // Stack: array of { level, subcategory?, item? }
    ...
    useEffect(() => {
        const onHardwareBack = () => {
            ...
            return false; // let Expo Router handle (exits screen)
        };
    ...
    // ── Header ───────────────────────────────────
    const headerTitle = () =>
        ({ hi: 'भारतीय संविधान', ur: 'ہندوستانی آئین' }[lang] || 'Indian Constitution');
    ...
    const renderSubcategoryList = () => (
        ...
        >
            {CONSTITUTION_DATA.subcategories.map((sub) => (
                <TouchableOpacity
                    key={sub.id}
