...
import { CYBER_CRIMES_DATA } from '../constants/cyberCrimesData';
...
export default function Cyber() {
    ...
    const headerTitle = () =>
        ({ hi: 'साइबर अपराध', ur: 'سائبر جرائم' }[lang] || 'Cyber Crimes');
    ...
    const renderSubcategoryList = () => (
        ...
        >
            {CYBER_CRIMES_DATA.subcategories.map((sub) => (
                <TouchableOpacity
                    key={sub.id}
