...
import { OTHER_OFFENCES_DATA } from '../constants/otherOffencesData';
...
export default function Other() {
    ...
    const headerTitle = () =>
        ({ hi: 'अन्य अपराध', ur: 'دیگر جرائم' }[lang] || 'Other Offences');
    ...
    const renderSubcategoryList = () => (
        ...
        >
            {OTHER_OFFENCES_DATA.subcategories.map((sub) => (
                <TouchableOpacity
                    key={sub.id}
